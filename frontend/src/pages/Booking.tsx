        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            <motion.div key="step1" initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} exit={{ opacity:0, y:-24 }} transition={{ duration:.5 }}>
              ...
              <div style={{ marginBottom:24 }}>
                <p style={{ fontFamily:'IBM Plex Sans, sans-serif', fontWeight:600, fontSize:12, letterSpacing:'0.1em', color:'rgba(240,239,231,.4)', textTransform:'uppercase', marginBottom:14 }}>Try for free</p>
                <motion.button
                  whileHover={{ y:-3 }}
                  whileTap={{ scale:.99 }}
                ...
                >
                  ...
                  <div style={{ flex:1 }}>
                    <div style={{ fontFamily:'IBM Plex Sans, sans-serif', fontWeight:700, fontSize:18, color:'#F0EFE7', marginBottom:6 }}>Free Demo Session</div>
                  ...
                  <div style={{ textAlign:'right', flexShrink:0 }}>
                    <div style={{ fontFamily:'IBM Plex Sans, sans-serif', fontWeight:800, fontSize:24, color:'#00FF87' }}>Free</div>
                    <div style={{ fontFamily:'IBM Plex Sans, sans-serif', fontSize:12, color:'rgba(240,239,231,.4)', marginTop:2 }}>No payment</div>
                  </div>
              ...
              {/* Paid courses */}
              <p style={{ fontFamily:'IBM Plex Sans, sans-serif', fontWeight:600, fontSize:12, letterSpacing:'0.1em', color:'rgba(240,239,231,.4)', textTransform:'uppercase', marginBottom:14 }}>Or choose a course</p>

              {loadCourses ? (
                <div style={{ textAlign:'center', padding:40, color:'rgba(240,239,231,.4)', fontFamily:'IBM Plex Sans, sans-serif' }}>Loading courses...</div>
              ) : (
          ...
          {step === 2 && (
            <motion.div key="step2" initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} exit={{ opacity:0, y:-24 }} transition={{ duration:.5 }}>
              <button onClick={() => setStep(1)} style={{ background:'none', border:'none', color:'rgba(240,239,231,.45)', cursor:'pointer', display:'flex', alignItems:'center', gap:6, marginBottom:28, fontSize:14, fontFamily:'IBM Plex Sans, sans-serif' }}><ChevronLeft size={16} /> Back</button>
              ...
              <div style={{ background: isFreeDemo ? 'rgba(0,255,135,.06)' : 'rgba(96,165,250,.06)', border: `1px solid ${isFreeDemo ? 'rgba(0,255,135,.2)' : 'rgba(96,165,250,.2)'}`, borderRadius:10, padding:'14px 20px', marginBottom:28, display:'flex', alignItems:'center', gap:12 }}>
                ...
                <span style={{ fontFamily:'IBM Plex Sans, sans-serif', fontWeight:700, fontSize:15, color:'#F0EFE7' }}>{selCourse?.title}</span>
              ...
              <div className="booking-cal-grid" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:24 }}>
                ...
                <div style={{ background:'rgba(255,255,255,.03)', border:'1px solid rgba(255,255,255,.07)', borderRadius:12, padding:28 }}>
                  ...
                  <p style={{ fontSize:11, color:'rgba(240,239,231,.3)', marginTop:16, fontFamily:'IBM Plex Sans, sans-serif', textAlign:'center' }}>Weekdays only · Slots update live</p>
                </div>
                ...
                <div style={{ background:'rgba(255,255,255,.03)', border:'1px solid rgba(255,255,255,.07)', borderRadius:12, padding:28 }}>
                  ...
                  {!selDate ? (
                    <div style={{ display:'grid', placeItems:'center', height:200, color:'rgba(240,239,231,.25)', fontFamily:'IBM Plex Sans, sans-serif', fontSize:14, textAlign:'center' }}>← Pick a date to see<br />live available slots</div>
                  ) : (
                    <>
                    <div style={{ display:'flex', alignItems:'center', gap:6, marginBottom:10 }}>
                      ...
                      <span style={{ fontFamily:'IBM Plex Sans, sans-serif', fontSize:12, color:'rgba(240,239,231,.4)' }}>
                        All times in Berlin time (CET/CEST)
                      </span>
                    </div>
          ...
          {step === 3 && (
            <motion.div key="step3" initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} exit={{ opacity:0, y:-24 }} transition={{ duration:.5 }}>
              <div className="booking-confirm" style={{ maxWidth:520, margin:'0 auto', background:'rgba(255,255,255,.03)', border:'1px solid rgba(255,255,255,.07)', borderRadius:12, padding:40 }}>
                <button onClick={() => setStep(2)} style={{ background:'none', border:'none', color:'rgba(240,239,231,.45)', cursor:'pointer', display:'flex', alignItems:'center', gap:6, marginBottom:28, fontSize:14, fontFamily:'IBM Plex Sans, sans-serif' }}><ChevronLeft size={16} /> Back</button>
                ...
                <div style={{ background: isFreeDemo ? 'rgba(0,255,135,.06)' : 'rgba(96,165,250,.06)', border:`1px solid ${isFreeDemo ? 'rgba(0,255,135,.2)' : 'rgba(96,165,250,.2)'}`, borderRadius:10, padding:20, marginBottom:24 }}>
                  {[
                    ...
                    { label:'Time',    value: selTime ? `${selTime} (Berlin time)` : '' },
                ...
                <div style={{ marginBottom:16 }}>
                  <label style={{ display:'block', fontFamily:'IBM Plex Sans, sans-serif', fontWeight:600, fontSize:12, letterSpacing:'0.08em', color:'rgba(240,239,231,.6)', marginBottom:8, textTransform:'uppercase' }}>Child's Name</label>
                ...
                <div style={{ marginBottom:16 }}>
                  <label style={{ display:'block', fontFamily:'IBM Plex Sans, sans-serif', fontWeight:600, fontSize:12, letterSpacing:'0.08em', color:'rgba(240,239,231,.6)', marginBottom:8, textTransform:'uppercase' }}>Child's Age</label>
                ...
                <div style={{ marginBottom:28 }}>
                  <label style={{ display:'block', fontFamily:'IBM Plex Sans, sans-serif', fontWeight:600, fontSize:12, letterSpacing:'0.08em', color:'rgba(240,239,231,.6)', marginBottom:8, textTransform:'uppercase' }}>Notes (Optional)</label>
                ...
                {!user && (
                  <div style={{ background:'rgba(251,191,36,.08)', border:'1px solid rgba(251,191,36,.3)', borderRadius:10, padding:16, marginBottom:20 }}>
                    <p style={{ color:'#fbbf24', fontSize:14, fontFamily:'IBM Plex Sans, sans-serif' }}>⚠️ You need to log in to confirm your booking.</p>
                    <button onClick={() => setPage('login')} style={{ marginTop:10, background:'rgba(251,191,36,.15)', border:'1px solid rgba(251,191,36,.3)', borderRadius:6, padding:'8px 16px', color:'#fbbf24', cursor:'pointer', fontFamily:'IBM Plex Sans, sans-serif', fontWeight:600, fontSize:13 }}>Sign In / Sign Up</button>
                  </div>
                )}
          ...
          {step === 4 && (
            <motion.div key="step4" initial={{ opacity:0, scale:.95 }} animate={{ opacity:1, scale:1 }} transition={{ duration:.6 }}>
              <div style={{ maxWidth:500, margin:'0 auto', textAlign:'center' }}>
                ...
                <h1 style={{ fontFamily:'IBM Plex Sans, sans-serif', fontWeight:800, fontSize:40, marginBottom:16 }}>You're Booked!</h1>
